...
$("#AdminServiceRequesttable").click(function (e) {
...
$(document).on("click", "#servicertabbtn", function () {
    console.log("45 get AdminServiceRequest()");
    if ($.fn.DataTable.isDataTable("#AdminServiceRequesttable")) {
        $('#AdminServiceRequesttable').DataTable().clear().destroy();
    }
...
$(document).on("click", "#filterSubmit", function () {
    console.log("83 submit get AdminServiceRequest()");
    if ($.fn.DataTable.isDataTable("#AdminServiceRequesttable")) {
        $('#AdminServiceRequesttable').DataTable().clear().destroy();
    }
    getAdminServiceRequest();
...
function getAdminServiceRequest() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#AdminServiceRequestTbody").empty();
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                $("#AdminServiceRequestTbody").append(html);
            }
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var createdDateTemp = new Date(result[i].toString());
...
function adminserviceDatatable() {
    ...
    $("#AdminServiceRequesttable").DataTable({
